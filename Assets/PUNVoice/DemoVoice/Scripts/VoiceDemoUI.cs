...
namespace ExitGames.Demos.DemoPunVoice {
    ...
    public class VoiceDemoUI : MonoBehaviour {
...
#if UNITY_EDITOR
        private Toggle[] globalSettingsToggles;
#endif
        ...
        private Client.Photon.DebugLevel previousDebugLevel;
        ...
        private void Start()
        {
            ...
            {
#if UNITY_EDITOR
                globalSettingsToggles = globalSettings.GetComponentsInChildren<Toggle>();
