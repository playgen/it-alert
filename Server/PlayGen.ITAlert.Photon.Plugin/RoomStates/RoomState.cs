...
namespace PlayGen.ITAlert.Photon.Plugin.RoomStates
{
    public abstract class RoomState : PlayGen.Photon.Plugin.States.RoomState
    {
        ...
        protected RoomState(PluginBase photonPlugin, Messenger messenger, PlayerManager playerManager, RoomSettings roomSettings, AnalyticsServiceManager analytics) 
