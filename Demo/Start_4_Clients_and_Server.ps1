...
& ".\Client\IT Alert!_StandaloneWindows64.exe" -a -u ITAlert_User2 -p t0pSECr3t -s SUGAR
& ".\Client\IT Alert!_StandaloneWindows64.exe" -a -u ITAlert_User3 -p t0pSECr3t -s SUGAR
& ".\Client\IT Alert!_StandaloneWindows64.exe" -a -u ITAlert_User4 -p t0pSECr3t -s SUGAR
