...
& .\Client\StandaloneWindows64.exe -a -u ITAlert_User2 -p t0pSECr3t -s SUGAR
& .\Client\StandaloneWindows64.exe -a -u ITAlert_User3 -p t0pSECr3t -s SUGAR
& .\Client\StandaloneWindows64.exe -a -u ITAlert_User4 -p t0pSECr3t -s SUGAR
