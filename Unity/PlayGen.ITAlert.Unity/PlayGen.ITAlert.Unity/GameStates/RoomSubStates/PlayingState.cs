...
namespace PlayGen.ITAlert.Unity.GameStates.RoomSubStates
{
	public class PlayingState : InputTickState , ICompletable
	{
		...
		protected override void OnEnter()
		{
			...
			IsComplete = false;
			_photonClient.CurrentRoom.Messenger.Subscribe((int)Channel.SimulationState, ProcessSimulationStateMessage);
		...
		{
			_photonClient.CurrentRoom.Messenger.Unsubscribe((int)Channel.SimulationState, ProcessSimulationStateMessage);
		}
