...
public class FeedbackStateInput : TickStateInput
{
	...
	private readonly Dictionary<string, List<KeyValuePair<FeedbackSlotBehaviour, FeedbackDragBehaviour>>> _rankingObjects = new Dictionary<string, List<KeyValuePair<FeedbackSlotBehaviour, FeedbackDragBehaviour>>>();
	...
	public FeedbackStateInput(Client client)
	{
		_client = client;
	}
	...
	{
		PopulateFeedback(_client.CurrentRoom.Players, _client.CurrentRoom.Player);
	...
	private void OnSendClick()
	{
		...
		var players = _client.CurrentRoom.Players;
