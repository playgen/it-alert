...
namespace PlayGen.ITAlert.Unity.GameStates.RoomSubStates
{
	public class InitializingState : TickState
	{
		...
		protected override void OnEnter()
		{
			...
			_networkPhotonClient.CurrentRoom.Messenger.Subscribe((int)Channels.SimulationState, ProcessSimulationStateMessage);
		...
		{
			_networkPhotonClient.CurrentRoom.Messenger.Unsubscribe((int)Channels.SimulationState, ProcessSimulationStateMessage);
		}
