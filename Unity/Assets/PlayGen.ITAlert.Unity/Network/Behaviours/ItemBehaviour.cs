...
namespace PlayGen.ITAlert.Unity.Network.Behaviours
{
	...
	{
		[SerializeField] private Image _activationTimerImage;
		...
		{
			get { return EntityState != null && EntityState.Active; }
		}

		public int? Owner
		{
			get { return EntityState == null ? (int?) null : EntityState.Owner; }
		}
		...
		{
			get { return EntityState.CurrentNode.HasValue; }
		}
