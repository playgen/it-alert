...
namespace PlayGen.ITAlert.Unity.Network.Behaviours
{
	...
	{
		[SerializeField] private Color[] _weightColors = new Color[]
		{
		};
		...
		private void DrawConnection(int headId, int tailId)
		{
			...
			var relativeWeight = (SimulationConstants.ConnectionMaxWeight + 1 - EntityState.RelativeWeight) *
								UIConstants.ConnectionWidth;
