...
namespace PlayGen.ITAlert.Unity.Network.Behaviours
{
	...
	{
		[SerializeField] private GameObject _bigVirus;
		...
		void Update()
		{
			if (_animationProgress < 1)
			{
				...
				_bigVirus.transform.localPosition = new Vector3(InitialOffset.x,
					Mathf.SmoothStep(InitialOffset.y, 0, _animationProgress));
			}
		}
