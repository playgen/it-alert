...
public class PhotonVoiceNetwork : MonoBehaviour
{
    ...
    public static bool Connect()
    {
        ...
        {
            Debug.LogFormat("PUNVoice: connecting to master {0}", PhotonNetwork.networkingPeer.MasterServerAddress);
    ...
    public static UnityVoiceClient Client { get { return instance.client; } }
...
public class UnityVoiceClient : Voice.Client
{
    ...
    new public Action<int, byte, Voice.VoiceInfo> OnRemoteVoiceInfoAction { get; set; }
    new public Action<int, byte> OnRemoteVoiceRemoveAction { get; set; }
    new public Action<int, byte, float[]> OnAudioFrameAction { get; set; }
    ...
    {
        base.OnRemoteVoiceInfoAction = OnRemoteVoiceInfo;
        base.OnRemoteVoiceRemoveAction = OnRemoteVoiceRemove;
        base.OnAudioFrameAction = OnAudioFrame;
