...
namespace PlayGen.ITAlert.Simulation.Visitors.Actors
{
	public class Player : Actor<PlayerState>
	{
		...
		/// Constructor
		/// </summary>
		public Player(ISimulation simulation, string name, string colour)
			: this(simulation, name, colour, SimulationConstants.PlayerSpeed)
		{
		}

		public Player(ISimulation simulation, string name, string colour, int speed)
			: base(simulation, EntityType.Player, speed)
		{
			Name = name;
			Colour = colour;
		}
