...
namespace PlayGen.ITAlert.Simulation.Systems
{
	public class System : ITAlertEntity<SystemState>, INode
	{
		...
		/// 
		/// </summary>
		private SystemEnhancement _enhancement;

		#region constructors

		public System(ISimulation simulation, int logicalId, SystemEnhancement enhancement, int x, int y) 
			: this(simulation, logicalId, enhancement, SimulationConstants.Positions, x, y)
		{
		}

		protected System(ISimulation simulation, int logicalId, SystemEnhancement enhancement, int positions, int x, int y)
			: base(simulation, EntityType.System, positions)
		{
			LogicalId = logicalId;
