...
{
	public delegate void AddVisitorToNode(Entity node, Entity visitor, Entity source, int initialPosition, int currentTick);

	public interface IMovementSystemComponent : ISystemComponent
	{
