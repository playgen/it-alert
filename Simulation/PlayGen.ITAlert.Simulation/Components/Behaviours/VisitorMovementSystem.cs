...
namespace PlayGen.ITAlert.Simulation.Systems.Behaviours
{
	...
	[ComponentDependency(typeof(IMovementType))]
	public class VisitorMovementSystem : Component, ITickableComponent
	{
		private readonly Dictionary<int, VisitorPosition> _visitorPositions;
		
		public VisitorMovementSystem(IEntity entity) 
			: base(entity)
		{
		}
