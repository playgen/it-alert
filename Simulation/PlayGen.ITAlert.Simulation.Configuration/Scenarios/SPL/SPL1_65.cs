...
namespace PlayGen.ITAlert.Simulation.Configuration.Scenarios.SPL
{
	...
	internal class SPL1_65 : ScenarioFactory
	{
		public SPL1_65()
			: base(key: "SPL1_0.65",
				nameToken: "SPL Scenario 1 [65%]",
				descriptionToken: "SPL Scenario 1 - Virus Propogation Rate 65%",
				minPlayers: 1,
				maxPlayers: 4,
		...
		public static readonly Archetype RedVirus65 = new Archetype(nameof(RedVirus65))
		...
		public override SimulationScenario GenerateScenario()
		{
			...
			scenario.Sequence.Add(
				new SimulationFrame()
				{
					...
					{
						new CreateMalware(RedVirus65, node01)
					},
				}
			);
			...
			scenario.Sequence.Add(
				new SimulationFrame()
				{
					...
					{
						new ConditionalAction<Simulation, SimulationConfiguration>(new NodeSequenceAction(spawnSequence, ec => new CreateMalware(RedVirus65, ec)), 
