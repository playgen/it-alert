...
namespace PlayGen.ITAlert.Simulation.Configuration.Scenarios.SPL
{
	...
	internal class SPL1_35 : ScenarioFactory
	{
		public SPL1_35()
			: base(key: "SPL1_0.35",
				nameToken: "SPL Scenario 1 [35%]",
				descriptionToken: "SPL Scenario 1 - Virus Propogation Rate 35%",
				minPlayers: 1,
				maxPlayers: 4,
		...
		public static readonly Archetype RedVirus35 = new Archetype(nameof(RedVirus35))
		...
		public override SimulationScenario GenerateScenario()
		{
			...
			scenario.Sequence.Add(
				new SimulationFrame()
				{
					...
					{
						new CreateMalware(RedVirus35, node01)
					},
				}
			);
			...
			scenario.Sequence.Add(
				new SimulationFrame()
				{
					...
					{
						new ConditionalAction<Simulation, SimulationConfiguration>(new NodeSequenceAction(spawnSequence, ec => new CreateMalware(RedVirus35, ec)), 
