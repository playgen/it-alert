...
namespace PlayGen.Engine.Entities
{
		...
		where TGameState : EntityState
	{
		...
		protected EntityBase(IEntityRegistry entityRegistry, IComponentContainer componentContainer)
		{
			NotNullHelper.ArgumentNotNull(entityRegistry, nameof(entityRegistry));
			EntityRegistry = entityRegistry;
			Id = entityRegistry.EntitySeed;

			Container = componentContainer ?? Components.ComponentContainer.Default;
		}
